...
class BGPConfig:
    ...
    def set_local_pref(self,orderCheck, local_pref: int, from_peer: str,
        ...
        self.add_set_action(peer=from_peer,
                            set_action=RouteMapSetAction('local-preference',
                                                         local_pref),
                            matching=matching, direction='in', orderCheck=orderCheck)
        return self
    ...
    def add_set_action(self, peer: str, set_action: RouteMapSetAction,
                       matching: Sequence[Union[AccessList, CommunityList]],
                       direction: str, orderCheck=10) -> 'BGPConfig':
        ...
        route_maps.append(
            {'peer': peer, 'match_cond': match_cond,
             'set_actions': [set_action], 'direction': direction, 'order_check':orderCheck })
        return self
