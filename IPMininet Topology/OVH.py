...
class MyTopology(IPTopo):
	...
	# ================================================ START of Gravelines ================================================
        ...
        ''''
        par_gsw_sbb1_nc5.get_config(BGP).set_community(community='no-advertise', from_peer=par_gsw_border, matching=[AccessList(entries=(ipaddress.ip_network("8.8.0.0/16"), ))])
        par_gsw_sbb1_nc5.get_config(BGP).set_community(community='no-advertise', from_peer=par_gsw_border, matching=[AccessList(entries=(ipaddress.ip_network("2001:4860::/32"), ))])
        ...
        border_routers = [lon_thw_border, fra_1_border, fra_5_border, par_gsw_border, par_th2_border]
        ...
        vodafone_border_routers=[vodafone_r1,vodafone_r2,vodafone_r3,vodafone_r4]
        ...
        self.addSubnet(nodes=[vodafone_r3,vodafone_int],subnets=["2001:5000:1:3::/64","2.16.32.0/24"])
        ...
        self.addSubnet(nodes=[fra_5_border,vodafone_r4], subnets=["192.148.2.104/30", "2001:41D0:0:1F0C::/64"])
        self.addSubnet(nodes=[par_th2_border,vodafone_r2], subnets=["192.148.2.100/30", "2001:41D0:0:1F0B::/64"])

        ebgp_session(self,par_th2_border,vodafone_r2)
        ebgp_session(self,fra_5_border,vodafone_r4 )
        ebgp_session(self,fra_1_border,vodafone_r3 )
        ...
        cogent_border_routers=[cogent_r1,cogent_r2,cogent_r3]
        ...
        self.addSubnet(nodes=[cogent_r2, cogent_int], subnets=["2001:550:1:2::/64","2.58.6.0/24"])
        ...
        self.addSubnet(nodes=[par_gsw_border,cogent_r1], subnets=["192.148.2.116/30", "2001:41D0:0:1F0F::/64"])

        ebgp_session(self,par_gsw_border,cogent_r1 )
        ebgp_session(self,lon_thw_border,cogent_r3 )
        ...
        telia_border_routers=[telia_r1,telia_r2,telia_r3]
        ...
        self.addSubnet(nodes=[lon_thw_border,telia_r3], subnets=["192.148.2.136/30", "2001:41D0:0:1F14::/64"])

        ebgp_session(self,fra_5_border,telia_r2 )
        ebgp_session(self,fra_1_border,telia_r1 )
        ...
        amazon_r1=self.addRouter("amazon_r1",config=RouterConfig,lo_addresses=["2001:4f8:0:1::/64","3.5.128.1/32"])
        amazon_r2=self.addRouter("amazon_r2",config=RouterConfig,lo_addresses=["2001:4f8:0:2::/64","3.5.128.2/32"])
        amazon_border_routers=[amazon_r1,amazon_r2]
        ...
        ebgp_session(self,par_th2_border,amazon_r1 )
        ...
        fra_1_border.get_config(BGP).set_community(community='16276:2030', from_peer=vodafone_r3)
        fra_1_border.get_config(BGP).set_community(community='16276:2010', from_peer=telia_r1)

        fra_5_border.get_config(BGP).set_community(community='16276:2040', from_peer=google_r3)
        fra_5_border.get_config(BGP).set_community(community='16276:2030', from_peer=vodafone_r4)
        fra_5_border.get_config(BGP).set_community(community='16276:2010', from_peer=telia_r2)

        par_gsw_border.get_config(BGP).set_community(community='16276:2020', from_peer=cogent_r1)
        par_gsw_border.get_config(BGP).set_community(community='16276:2040', from_peer=google_r1)
        par_gsw_border.get_config(BGP).set_community(community='16276:2010', from_peer=vodafone_r1)

        par_th2_border.get_config(BGP).set_community(community='16276:2040', from_peer=google_r2)
        ...
        lon_thw_border.get_config(BGP).deny(to_peer=telia_r3,matching=[CommunityList(community='16276:2010')],order=11)
        lon_thw_border.get_config(BGP).deny(to_peer=cogent_r3,matching=[CommunityList(community='16276:2020')],order=12)
        lon_thw_border.get_config(BGP).deny(to_peer=amazon_r2,matching=[CommunityList(community='16276:2050')],order=13)

        fra_1_n7.get_config(BGP).deny(to_peer=vodafone_r3,matching=[CommunityList(community='16276:2030')],order=14)
        fra_1_n7.get_config(BGP).deny(to_peer=telia_r1,matching=[CommunityList(community='16276:2010')],order=15)

        fra_5_n7.get_config(BGP).deny(to_peer=google_r3,matching=[CommunityList(community='16276:2040')],order=16)
        fra_5_n7.get_config(BGP).deny(to_peer=vodafone_r4,matching=[CommunityList(community='16276:2030')],order=17)
        fra_5_n7.get_config(BGP).deny(to_peer=telia_r2,matching=[CommunityList(community='16276:2030')],order=18)

        par_gsw_border.get_config(BGP).deny(to_peer=cogent_r1,matching=[CommunityList(community='16276:2020')],order=19)
        par_gsw_border.get_config(BGP).deny(to_peer=google_r1,matching=[CommunityList(community='16276:2040')],order=20)
        par_gsw_border.get_config(BGP).deny(to_peer=vodafone_r1,matching=[CommunityList(community='16276:2030')],order=21)

        par_th2_sbb1_nc5.get_config(BGP).deny(to_peer=google_r2,matching=[CommunityList(community='16276:2040')],order=22)
        par_th2_sbb1_nc5.get_config(BGP).deny(to_peer=cogent_r2,matching=[CommunityList(community='16276:2020')],order=23)
        par_th2_sbb1_nc5.get_config(BGP).deny(to_peer=amazon_r1,matching=[CommunityList(community='16276:2050')],order=24)
        par_th2_sbb1_nc5.get_config(BGP).deny(to_peer=vodafone_r2,matching=[CommunityList(community='16276:2030')],order=25)

        '''********************   CUSTOM LOCAL-PREF     **********************************'''
        '''
        setlocalPrefs(lon_thw_border,LOCAL_PREFS,fromPeer=telia_r3,ipv4='2.255.248.3/32',ipv6='2001:2000:0:3::')
        setlocalPrefs(lon_thw_border,LOCAL_PREFS,fromPeer=amazon_r2,ipv4='3.5.128.2/32',ipv6='2001:4f8:b:0:2::')
        setlocalPrefs(lon_thw_border,LOCAL_PREFS,fromPeer=cogent_r3,ipv4='2.58.4.3/32',ipv6='2001:550:0:3::')

        setlocalPrefs(fra_1_border,LOCAL_PREFS,fromPeer=vodafone_r3,ipv4='2.16.35.3/32',ipv6='2001:5000:0:3::')
        setlocalPrefs(fra_1_border,LOCAL_PREFS,fromPeer=telia_r1,ipv4='2.255.248.1/32',ipv6='2001:2000:0:1::')

        setlocalPrefs(fra_5_border,LOCAL_PREFS,fromPeer=google_r3,ipv4='8.8.4.3/32',ipv6='2001:4860:0:3::')
        setlocalPrefs(fra_5_border,LOCAL_PREFS,fromPeer=vodafone_r4,ipv4='2.16.35.4/32',ipv6='2001:5000:0:4::')
        setlocalPrefs(fra_5_border,LOCAL_PREFS,fromPeer=telia_r2,ipv4='2.255.248.2/32',ipv6='2001:2000:0:2::')

        setlocalPrefs(par_gsw_border,LOCAL_PREFS,fromPeer=cogent_r1,ipv4='2.58.4.1/32',ipv6='2001:550:0:1::/64')
        setlocalPrefs(par_gsw_border,LOCAL_PREFS,fromPeer=google_r1,ipv4='8.8.4.1/32',ipv6='2001:4860:0:1::/64')
        setlocalPrefs(par_gsw_border,LOCAL_PREFS,fromPeer=vodafone_r1,ipv4='2.16.35.1/32',ipv6='2001:5000:0:1::/64')

        setlocalPrefs(par_th2_border,LOCAL_PREFS,fromPeer=google_r2,ipv6='2001:4860:0:1::',ipv4='8.8.4.2/32')
        setlocalPrefs(par_th2_border,LOCAL_PREFS,fromPeer=cogent_r2,ipv4='2.58.4.2/32',ipv6='2001:550:0:2::')
        setlocalPrefs(par_th2_border,LOCAL_PREFS,fromPeer=amazon_r1,ipv4='3.5.128.1/32',ipv6='2001:4f8:b:0:1::')
...
def setLocalPref(router,localPref,communityNbr,fromPeer,ipv4,ipv6,orderCheck):
    router.get_config(BGP).set_local_pref(local_pref=localPref,
        from_peer=fromPeer,
        matching=[
            CommunityList(community=communityNbr),
            AccessList(entries=[ipv4,ipv6])
        ],orderCheck=orderCheck)

def setlocalPrefs(router,localPrefCommList,fromPeer,ipv4,ipv6):
    all_al=AccessList('all',('any',))
    #router.get_config(BGP).permit(from_peer=fromPeer,matching=(all_al,)) #deault permit route
    #router.get_config(BGP).permit(to_peer=fromPeer,matching=(all_al,))  #deault permit route
    i=1
    for e in localPrefCommList:
        setLocalPref(router,localPref=e[1],communityNbr=e[0],fromPeer=fromPeer,ipv4=ipv4,ipv6=ipv6,orderCheck=i)
        i+=1
